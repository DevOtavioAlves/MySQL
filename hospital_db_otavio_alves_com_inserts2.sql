...
START TRANSACTION;
USE `hospital_otavio_alves`;
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (1, 'Hevelyn Yabuta', '33962714758', '213609599', '1957-04-14', 0);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (2, 'Joelma de Sa', '88237489764', '342848288', '1973-04-21', 1);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (3, 'Joemia Carmanin', '97402595706', '176756401', '1940-02-23', 1);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (4, 'Gutemberg Zava', '26325146735', '270366714', '1992-04-09', 1);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (5, 'Tania Werneck', '63242671724', '367028360', '1943-12-08', 0);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (6, 'Soraya Siqueira', '68654445742', '101047186', '1962-02-06', 1);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (7, 'Geanny Koga', '76698442720', '182725388', '1956-07-28', 1);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (8, 'Vinicius Garbelini', '97753893726', '189268037', '1998-09-08', 1);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (9, 'Sedenir Giacomini', '20078512700', '425221222', '1984-05-30', 1);
INSERT INTO `hospital_otavio_alves`.`Medico` (`id`, `nome`, `cpf`, `rg`, `data_nascimento`, `em_atividade`) VALUES (10, 'Rejane Feitosa', '27659675710', '348780709', '1945-11-14', 1);
...
-- -----------------------------------------------------
-- Data for table `hospital_otavio_alves`.`Medico_Especialidade`
-- -----------------------------------------------------
START TRANSACTION;
USE `hospital_otavio_alves`;
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (1, 1);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (2, 3);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (2, 2);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (3, 5);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (4, 4);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (5, 6);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (5, 1);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (6, 3);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (7, 5);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (7, 4);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (8, 2);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (9, 7);
INSERT INTO `hospital_otavio_alves`.`Medico_Especialidade` (`medico_id`, `especialidade_id`) VALUES (10, 1);
...
INSERT INTO `hospital_otavio_alves`.`Internacao` (`id`, `data_entrada`, `data_prev_alta`, `data_alta`, `procedimento`, `paciente_id`, `medico_id`, `quarto_id`) VALUES (3, '2021-12-17 14:28:42', '2021-12-18 20:00:00', '2021-01-15 21:54:41', 'Alergias pelo Corpo', 3, 6, 2);
